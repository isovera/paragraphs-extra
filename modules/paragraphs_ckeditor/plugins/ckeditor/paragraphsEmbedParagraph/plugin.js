...
( function($) {
  ...
  var ModalEventHandler = function(editor, mode, widget) {
    ...
    this.onEmbedFormComplete = function(modal, event_name, form_id, rendered_entity) {
      ...
      if (mode == 'embed') {
        ...
        editor.widgets.initOn(element, 'paragraphsEmbedParagraphWidget');
  ...
  CKEDITOR.plugins.add( 'paragraphsEmbedParagraph', {
    requires : [ "widget" ],
    ...
    init : function (editor) {
      ...
      editor.addCommand( 'paragraphsEmbedParagraph', {
      ...
      editor.ui.addButton( 'paragraphsInsertParagraph', {
        label: 'Embed',
        command: 'paragraphsEmbedParagraph',
        toolbar: 'insert',
        icon: this.path + '/icons/paragraphsEmbedParagraph.png',
      } );
      editor.widgets.add('paragraphsEmbedParagraphWidget', {
        allowedContent: true,
        requiredContent: 'paragraphs-ckeditor-paragraph[*]',
